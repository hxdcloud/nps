...
![image](https://github.com/hxdcloud/nps/blob/master/docs/windows_client_service_configuration.png?raw=true)
...
```
## 配置文件说明
[示例配置文件](https://github.com/hxdcloud/nps/tree/master/conf/npc.conf)
#### 全局配置
```ini
[common]
